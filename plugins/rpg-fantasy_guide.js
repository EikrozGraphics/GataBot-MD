...
_Aquí, te proporcionaré información esencial para que te conviertas en un maestro en el emocionante mundo de los usuarios *Fantasy* en *EikrozBot*._
...
*¿Te gustaría proponer tus propios personajes para que formen parte de EikrozBot?*
¡Es sencillo! Solo utiliza el comando \`${usedPrefix}fyadd* o *${usedPrefix}fyagregar\` y sigue la guía proporcionada para comenzar a crear tu solicitud de personajes. Los desarrolladores estarán encantados de recibir tus propuestas y considerarlas para enriquecer la experiencia en EikrozBot.
...
*¿Quieres conocer todos los personajes disponibles en EikrozBot?*

Con el comando \`${usedPrefix}fylista o ${usedPrefix}fyl\`, puedes acceder a una lista completa de todos los personajes disponibles en EikrozBot. Además, podrás explorar diferentes categorías.
