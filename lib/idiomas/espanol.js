...
const smsRowner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO EIKROZ LO PUEDE USAR!!\`\`\`` }//NUMERO DE BOT
...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE EIKROZBOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR EIKROZBOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 𝙎𝙪𝙥𝙚𝙧 𝙀𝙞𝙠𝙧𝙤𝙯𝘽𝙤𝙩-𝙈𝘿 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar EikrozBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar EikrozBot en Grupos`}
...
const smsContacto4 = () => { return 'Contacto Oficial de EikrozBot 🐈'}
